...
/* sourceType: subsystem for arm prototype control project

* sourceStatus: functional

* useContext: define objects for 1 PWM motor control, absolute encoder, PID 
* const. and other param; single subsys method getAngle used in robot.j
*/
